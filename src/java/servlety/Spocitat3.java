 ...
 * @author david
 */
public class Spocitat3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Object[][] souhrn10 = Seznam.SeznamZDatabaze.vytvorKolekci("UPDATE OBJEDNAVKA SET Spinosauroidea=" + dinosaur9 + ",Allosauridae=" + dinosaur10 + ",Dromaeosauridae=" + dinosaur11 + ",Macronaria=" + dinosaur12 + " WHERE IDZAKAZNIKA='"+uzavatel+"'", "dnadler", "nadlerka", "org.apache.derby.jdbc.ClientDriver", "jdbc:derby://localhost:1527/ONLINEOBCHOD");
