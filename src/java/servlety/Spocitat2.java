 ...
 * @author david
 */
public class Spocitat2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Object[][] souhrn10 = Seznam.SeznamZDatabaze.vytvorKolekci("UPDATE OBJEDNAVKA SET Nodosauridae=" + dinosaur5 + ",Herrerasauria=" + dinosaur6 + ",Ceratosauridae=" + dinosaur7 + ",Megalosauria=" + dinosaur8 + " WHERE IDZAKAZNIKA='"+uzavatel+"'", "dnadler", "nadlerka", "org.apache.derby.jdbc.ClientDriver", "jdbc:derby://localhost:1527/ONLINEOBCHOD");
